...
namespace Engine
{
    ...
    public class Camera
    {
        ...
        public static void Update()
        {
            ...
            projection = Matrix.CreatePerspectiveFieldOfView(Microsoft.Xna.Framework.MathHelper.ToRadians(90), (float)GameMain.inst.Window.ClientBounds.Width / (float)GameMain.inst.Window.ClientBounds.Height, 0.1f, 1000000f);
