...
namespace Engine
{
    ...
    public class Camera
    {
        ...
        public static void Update()
        {
            ...
            view = Matrix.CreateLookAt(-position, -position + MathHelper.GetForwardRotation(rotation), Vector3.UnitY);
            projection = Matrix.CreatePerspectiveFieldOfView(Microsoft.Xna.Framework.MathHelper.ToRadians(90), (float)GameMain.inst.Window.ClientBounds.Width / (float)GameMain.inst.Window.ClientBounds.Height, 0.1f, 10000f);
